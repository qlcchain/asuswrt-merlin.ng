...
#define MAX_FRIEND_WIFI_NUM 32
typedef struct Wifipassword
{
	bool isPasswordGot;
	bool isPasswordSaved;
	char ssid_name[SSID_LENGTH];
	char MAC_addr[18]; //b0:83:fe:78:56:a1
...
typedef struct {
	...
	WifiPassword wifipassword[MAX_FRIEND_WIFI_NUM];
