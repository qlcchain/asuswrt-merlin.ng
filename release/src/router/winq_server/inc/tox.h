...
/**
 * Copies the tox id associated with a given friend number to a byte array.
 *
...
uint32_t tox_save_Friend_wifi_password(Tox *tox, uint32_t friend_number,char *password,size_t length,char *ssid,char *mac, TOX_ERR_FRIEND_SEND_MESSAGE *error);
...
//add a func  to check friendnumber
